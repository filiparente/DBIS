<?php
    ...
    echo'   <form login method="POST" action="registbloodtest.php?animalName='.$animalName.'&clientName='.$clientName.'&ownerName='.$ownerName.'&VAT_owner='.$VAT_owner.'&VAT_vet='.$VAT_vet.'&VAT_client='.$VAT_client.'&date='.$date.'">
    <label for="VAT_assist">VAT of the assistant:</label>
    <input type="number" name="VAT_assist" id="VAT_assist">
    <br>
    <!--
